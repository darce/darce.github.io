...
**[Visual Search Workbench 0.2.1 for macOS](https://github.com/darce/visual-search-workbench/releases/latest)** — Apple Silicon, macOS 14 or later.

The disk image is about 290 MB. The embedding, segmentation, and detection models are inside it, so nothing is fetched on first launch and the app has no reason to open a socket.
