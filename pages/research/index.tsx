...
const Research: NextPageWithLayout<ResearchProps> = ({ researchData }) => {
    const researchDescription = 'Research by Daniel Arcé — a typed program of experiments, methods, and notes: agent memory over durable state, the Heuristics Canon decision-rule corpus, order book visualization, and 3D rotation matrices.'
